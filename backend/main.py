...
app = FastAPI(
    title="PyETL Pipeline",
    description="Python ETL pipeline framework with YAML config, scheduling, and monitoring",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "PyETL Pipeline"}
